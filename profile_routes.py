from attestation_focus import ensure_tables, check_all_modules_completed, issue_global_attestation, generate_attestation_pdf, get_user_certs_detail

def add_profile_routes(app):
    @app.route('/profile')
    def profile():
    ...
    def download_attestation():
        ...
        if not all_done:
            flash('Complete tous les modules pour obtenir l attestation.', 'warning')
